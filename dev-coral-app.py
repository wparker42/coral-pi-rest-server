...
TOP_K = 1  # should get from args
THRESHOLD = 0  # should get from args
...
def predict():
    ...
    if flask.request.method == "POST":
        ...
        if flask.request.files.get("image"):
            ...
            objs = detect.get_objects(interpreter, THRESHOLD, (scale, scale))
            ...
            if classes:
                ...
                for c in classes:
                    ...
                    inferd_classes.append(
                        {
                            "confidence": float(c.score),
                            "label": labels[c.id],
                        })
                data["class_predictions"] = inferd_classes
            else:
            ...
            if objs:
                ...
                data["object_predictions"] = inferd_objects
            else:
                print('\n No objects detected')
...
if __name__ == '__main__':
    ...
    parser.add_argument("--port", default=5080, type=int, help="port number")
